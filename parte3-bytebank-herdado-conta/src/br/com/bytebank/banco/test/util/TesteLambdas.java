...
public class TesteLambdas {
    ...
    public static void main(String[] args) {
        ...
        listaContas.sort( (c1, c2) -> Integer.compare(c1.getNumero(), c2.getNumero()) );
        ...
        listaContas.sort( (Conta c1, Conta c2) -> {
        ...
        listaContas.forEach ( (conta) -> System.out.println(conta + ", Titular: " + conta.getTitular().getNome()));
