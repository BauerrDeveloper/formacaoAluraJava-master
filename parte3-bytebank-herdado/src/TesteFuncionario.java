...
public class TesteFuncionario {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bonificação do funcionário: R$ " + funcionario1.getBonificacao());
		System.out.println("Salário total do mês: R$ " + (funcionario1.getSalario() + funcionario1.getBonificacao()));
