...
public class TesteString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Posição 2 tem o seguinte caracter: " + at);

		int pos = nome.indexOf("ue");
		System.out.println("A posição do (ue) dentro da String é a:  " + pos);

		String subString = nome.substring(1);
		System.out.println("A substring a partir da posição 1 é: " + subString);

		System.out.println("A String tem " + nome.length() + " caracteres.");

		for (int i = 0; i < nome.length(); i++) {
			System.out.println("O caractere na posição " + (i) + " é: " + nome.charAt(i));
		}

		System.out.println(" ");
		String vazio = "";
		System.out.println("Verificando se uma String está vazia: ");
		if (vazio.isEmpty()) {
			System.out.println("Sim, a string está vazia.");
		} else {
			System.out.println(
					"Tá vazio não. Não tá vendo? Quer que eu desenhe???" + " Olha aqui o que está escrito: " + vazio);
		}

		String meuNome = "               Rodrigo Paulo Bauernfeind              ";
		System.out.println("Meu nome antes do uso do trim(); --> " + meuNome);
		String trim = meuNome.trim();
		System.out.println("Meu nome após o uso do trim(); --> " + trim);

		System.out.println("");
		System.out.println("Nome, você contém (uer)?");
		...
		if (nome.contains("uer")) {
			...
			System.out.println("Não. False. Não sabe teu próprio nome não??");
		}

		
		System.out.println("");
		System.out.println("Veja o código sem usar  o StringBuilder: ");
		...
		System.out.println("Veja o mesmo código usando o StringBuilder: ");
